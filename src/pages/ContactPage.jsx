    ...
    <>
      ...
      >
        <main className="bg-[#f8f8f7] text-[#1f252b] w-[98vw]">
          ...
          >
            <h1 className="font-display text-5xl text-[#1f252b] sm:text-6xl">
              Contact Us
            </h1>
          ...
          >
              ...
              <div className="grid gap-8 rounded-2xl w-[60vw] -mt-46 bg-white p-6 sm:p-10 lg:grid-cols-[1.2fr_1fr] mx-auto">
                ...
                <div className="space-y-4">
                  {/* Map */}
                  <div className="h-40 rounded-lg border border-[#e0e5e3] bg-gradient-to-br from-[#c8e6c9] to-[#66bb6a] overflow-hidden">
                    <iframe
                      width="100%"
                      height="100%"
                      frameBorder="0"
                  ...
                  <section className="rounded-lg border border-[#e6ebea] bg-[#f9faf9] p-4">
                    <div className="flex items-start gap-3">
                      <svg
                        className="mt-0.5 h-5 w-5 text-[#d32f2f]"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-[#2f3941]">
                          No. 1.2 Abeola Odude Street, Victoria Island, Lagos,
                          Nigeria
                        </p>
                      </div>
                    </div>
