...
export const LEGACY_PROFILES = [
  {
    ...
    chronologyItems: [
      {
        year: "1500s",
        text: "Rose to prominence as royal advisor and Iyoba of Benin.",
      },
      {
        year: "1515",
        text: "Led strategic interventions during succession conflicts and territorial disputes.",
      },
      {
        year: "1540s",
        text: "Consolidated administrative reforms that strengthened central governance.",
      },
    ],
    impactStats: [
      { number: "40+", label: "Years of Service" },
      { number: "13", label: "Kingdoms Influenced" },
    ],
    resilienceTitle: "Leadership Legacy",
    resilienceText:
      "Queen Idia's legal and political legacy reflects structured governance, diplomatic discipline, and strategic statecraft that continues to define West African jurisprudence.",
    closingQuote: "\"Leadership is service in its highest and most courageous form.\"",
  },
  {
    slug: "oduduwa",
    name: "Oduduwa",
    ...
    chronologyItems: [
      {
        year: "Ancient",
        text: "Established foundational principles of kingship at Ile-Ife.",
      },
      {
        year: "Medieval Era",
        text: "Dynastic traditions spread across Yoruba territories and kingdoms.",
      },
      {
        year: "Present Day",
        text: "Remains central to Yoruba identity, constitutional memory, and governance.",
      },
    ],
    impactStats: [
      { number: "9", label: "Primary Kingdoms" },
      { number: "500+", label: "Years of Influence" },
    ],
    resilienceTitle: "Foundations of Order",
    resilienceText:
      "Oduduwa's legacy emphasizes lawful structure, legitimacy of institutions, and intergenerational continuity that continues to guide Yoruba communities.",
    closingQuote: "\"A people without memory cannot sustain a just future.\"",
  },
  {
    slug: "nefertiti",
    name: "Nefertiti",
    ...
    chronologyItems: [
      {
        year: "Amarna Era",
        text: "Rose to prominence during Egypt's most transformative cultural period.",
      },
      {
        year: "Reforms",
        text: "Associated with major socio-religious state policy transitions.",
      },
      {
        year: "Legacy",
        text: "Continues to influence modern discourse on women, leadership, and authority.",
      },
    ],
    impactStats: [
      { number: "1370", label: "BC - Peak Influence" },
      { number: "3000+", label: "Years of Legacy" },
    ],
    resilienceTitle: "Diplomacy & Influence",
    resilienceText:
      "Nefertiti's legacy reflects strategic partnership in governance, public legitimacy, and enduring state symbolism that transcends millennia.",
    closingQuote: "\"Influence is preserved not by titles, but by institutions and ideas.\"",
  },
];
