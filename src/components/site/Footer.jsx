...
const FOOTER_BG = "/assets/sections/footer.jpg";
const InstagramIcon = "/assets/sections/footer/social-icons/instagram.svg";
const TwitterIcon = "/assets/sections/footer/social-icons/x.svg";
const NEFERTITI = "/assets/sections/footer/nefertiti.png";
const ODUDUWA = "/assets/sections/footer/oduduwa.png";
const QUEEN_IDIA = "/assets/sections/footer/queen_idia.png";
        ...
        <div className="grid gap-6 sm:gap-8 md:gap-12 grid-cols-2 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <div className="space-y-1 text-xs sm:text-sm text-[#5f686f]">
              <Link href="/" className="block hover:text-[#1f676d] transition">
                Home
              </Link>
              <Link href="/about" className="block hover:text-[#1f676d] transition">
                About Us
              </Link>
              <Link href="/services" className="block hover:text-[#1f676d] transition">
                Services
              </Link>
              <Link href="/team" className="block hover:text-[#1f676d] transition">
                Team
              </Link>
              <Link href="/insights" className="block hover:text-[#1f676d] transition">
                Insights
              </Link>
              <Link href="/contact" className="block hover:text-[#1f676d] transition">
                Contact
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1 text-xs sm:text-sm text-[#5f686f]">
              <Link href="/terms" className="block hover:text-[#1f676d] transition">
                Terms
              </Link>
              <Link href="/privacy" className="block hover:text-[#1f676d] transition">
                Privacy
              </Link>
            </div>
          </div>
